...
DESCRIPTION
   ...
   The following five options are useful only when verifying checksums:
       ...
       The  sums are computed as described in FIPS-180-1.  When checking, the input should be a former output of this program.	The default mode is to print a
...
BUGS
       Do not use the SHA-1 algorithm for security related purposes.  Instead, use an SHA-2 algorithm, implemented in the programs sha224sum(1), sha256sum(1),
