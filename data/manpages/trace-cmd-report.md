TRACE-CMD-REPORT(1)						       libtracefs Manual						   TRACE-CMD-REPORT(1)
...
EXAMPLES
       ...
       The above needs a little explanation. The filter specifies the "sched" subsystem, which includes both sched_switch and sched_wakeup events. Any event
