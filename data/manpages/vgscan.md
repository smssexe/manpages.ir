...
OPTIONS
       ...
       --notifydbus
	      Send a notification to D-Bus. The command will exit with an error if LVM is not built with support for D-Bus notification, or if the notify_dbus
...
Red Hat, Inc.						       LVM TOOLS 2.03.16(2) (2022-05-18)						     VGSCAN(8)
