...
DESCRIPTION
   ...
   The following five options are useful only when verifying checksums:
       ...
       The  sums  are  computed as described in RFC 3874.  When checking, the input should be a former output of this program.	The default mode is to print a
...
GNU coreutils 9.4							  April 2024								  SHA224SUM(1)
